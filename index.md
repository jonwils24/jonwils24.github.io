...
-   [Welcome](../concepts/welcome-infocenter.md)
    ...
    -   [Installing](../concepts/master-ch-install.md)
        ...
        -   [Installing and configuring the Alfresco Transformation Server](../concepts/transerv-intro.md)
            ...
            -   [Transformation Server prerequisites](../concepts/transerv-prerequisites.md)
                ...
                -   [../concepts/transerv-client.dita](../concepts/transerv-client.md)
            ...
            -   [Configuring the Alfresco Transformation Server](../concepts/transerv-config.md)
                ...
                -   [../tasks/transerv-trans-client-config.dita](../tasks/transerv-trans-client-config.md)
    ...
    -   [Administering](../concepts/ch-administering.md)
        ...
        -   [Setting up high availability systems](../concepts/ha-intro.md)
            ...
            -   [../tasks/cluster-share-config.dita](../tasks/cluster-share-config.md)
